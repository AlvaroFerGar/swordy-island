...
const battleSystem = new BattleSystem(scene, camera, controls, guyblock, grid);
...
function animate() {
  ...
  for(let npc of pirate_list)
  {
    ...
    if (!guyblock_close_to_city) {
      battleSystem.checkCollisions([npc], guyblock_close_to_city);
    }
